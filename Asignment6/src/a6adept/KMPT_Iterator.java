...
public class KMPT_Iterator implements Iterator<SubPicture>
{
  ...
  public KMPT_Iterator(Picture source, int tile_width, int tile_height)
  {
    if (source == null) {
    ...
    cg = new CoordinateGenerator(0, 0, tile_width, tile_height, max_tile_x, max_tile_y);
  }
